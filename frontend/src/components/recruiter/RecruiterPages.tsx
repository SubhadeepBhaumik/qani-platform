        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3 pt-4">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => navigate('recruiter-jobs')} className="text-xs text-blue-600 hover:underline font-bold flex items-center gap-0.5">
                    ...
                    return (
                      <tr key={job.id} className="hover:bg-gray-50">
                        ...
                        <td className="p-4 text-right">
                          <button onClick={() => navigate('recruiter-applications')} className="text-xs font-semibold text-blue-600 hover:underline">
                            View Applicants
                          </button>
                        </td>
                      </tr>
            ...
            {bulkChecked.length > 0 && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg py-1.5 px-3 flex items-center gap-3 text-xs w-fit shadow-md">
                ...
                <div className="flex gap-1.5">
                  <button onClick={() => handleBulkStateChange('qualified')} className="bg-green-600 text-white font-bold py-1 px-2.5 rounded text-[10px]">Mark Qualified</button>
                  <button onClick={() => handleBulkStateChange('rejected')} className="bg-red-600 text-white font-bold py-1 px-2.5 rounded text-[10px]">Reject</button>
                  <button onClick={() => setBulkChecked([])} className="text-gray-500 hover:text-gray-900 text-[10px]">Cancel</button>
                </div>
              </div>
            )}
          </div>
              ...
              <div className="lg:col-span-8 bg-white border border-gray-200 rounded-xl p-6 sm:p-8 space-y-6 shadow-sm">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start gap-4 pb-6 border-b border-gray-100">
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <div>
                      <h1 className="text-2xl font-extrabold text-gray-950">{candidate?.firstName} {candidate?.lastName}</h1>
                      <span className="text-xs text-gray-500 font-semibold block uppercase tracking-wide">Applying For: {job?.title}</span>
                    </div>
                  </div>
                ...
                {app.scorecard ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="p-4 bg-gray-50 border rounded-xl space-y-2">
                        <div className="flex items-center justify-between text-xs font-bold text-gray-700">
                          ...
                          <span className="text-blue-600">{app.scorecard.locationScore}/100</span>
                        </div>
                      ...
                      <div className="p-4 bg-gray-50 border rounded-xl space-y-2">
                        <div className="flex items-center justify-between text-xs font-bold text-gray-700">
                          ...
                          <span className="text-blue-600">{app.scorecard.salaryScore}/100</span>
                        </div>
                        <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                      ...
                      <div className="p-4 bg-gray-50 border rounded-xl space-y-2">
                        <div className="flex items-center justify-between text-xs font-bold text-gray-700">
                          ...
                          <span className="text-blue-600">{app.scorecard.qualificationsScore}/100</span>
                        </div>
                        <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                      ...
                      <div className="p-4 bg-gray-50 border rounded-xl space-y-2">
                        <div className="flex items-center justify-between text-xs font-bold text-gray-700">
                          ...
                          <span className="text-blue-600">{app.scorecard.workRightsScore}/100</span>
                        </div>
                        <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                  ...
                  <div className="p-6 text-center border border-dashed rounded-xl">
                    ...
                    <button onClick={() => navigate('recruiter-queue')} className="mt-3 bg-blue-600 text-white py-1.5 px-3 rounded text-[11px] font-semibold">Invite screen</button>
                  </div>
                )}
                ...
                {session && (
                  <div className="space-y-4 pt-6 border-t border-gray-100">
                    <h3 className="text-sm font-bold uppercase text-gray-900 tracking-wider">Conversational Screening Transcripts</h3>
                    
                    <div className="space-y-3 bg-gray-50 p-4 rounded-xl max-h-80 overflow-y-auto border border-gray-250">
                      {session.messages.map(msg => (
                        <div key={msg.id} className="text-xs border-b border-gray-200/50 pb-2 mb-2">
                          <span className={`font-bold block tracking-wider uppercase text-[10px] ${msg.role === 'assistant' ? 'text-blue-600' : 'text-gray-900'}`}>
                            {msg.role === 'assistant' ? 'QANI AI Interviewer' : `${candidate?.firstName || 'User'}`}
                          </span>
                          <p className="text-gray-700 leading-relaxed mt-1">{msg.content}</p>
                        </div>
                      ))}
                    </div>
                  </div>
      ...
      {subView === 'jobs' && (
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            >
              <Plus className="w-4 h-4" />
              <span>Create Position Setup</span>
            </button>
          </div>
      ...
      {subView === 'reports' && (
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <button onClick={() => showToast('CSV Exporter triggered.', 'success')} className="text-xs font-semibold py-2 px-4 bg-gray-900 border text-white rounded-lg hover:bg-gray-800 flex items-center gap-1">
